...
def run_test():
    ...
    # After moving to psosp/__init__.py, __file__ points inside the package.
    # So, script_dir becomes the package directory itself.
    script_path = os.path.abspath(__file__)
    script_dir = os.path.dirname(script_path)
    
    # Paths are now relative to the package directory
...
def run_prediction(args):
    ...
    # After moving, script_dir correctly points to the 'psosp' package directory
    script_path = os.path.abspath(__file__)
    script_dir = os.path.dirname(script_path)
