...
- `prediction quality`: **`High`** for viral completeness between 90%-100% or predicted as SdPs; **`Medium`** for viral completeness between 50%-90%; **`Low`** for viral completeness lower than 50%
