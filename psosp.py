...
parser.add_argument('-vf', '--virus_fasta',required=True, help="Virus genome fasta file (can contain multiple viruses)")
...
parser.add_argument('-db', '--checkv_db', required=True, help="checkv reference database path)")
...
def predict_phage_type_multi(virus_intergenic_files, fna1, fna2, a3, ms_label3, regu, hi_dic, output_dir, has_blast_results, has_fimo_results, checkv_output_dir):
    ...
    # Read CheckV quality assessment results
    checkv_quality = {}
